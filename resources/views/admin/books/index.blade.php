        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ url('/admin/books/create') }}" class="btn btn-success btn-sm" title="Add New Book">
                            ...
                            <table class="table">
                                ...
                                @foreach($books as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ url('/admin/books/' . $item->id) }}" title="View Book"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                            <a href="{{ url('/admin/books/' . $item->id . '/edit') }}" title="Edit Book"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
